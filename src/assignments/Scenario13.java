...
public class Scenario13 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//span[@class='prcs-dlh' and @data-displayname='30% Making Charge Off' ]")).click();
		List<WebElement> discount = driver.findElements(By.xpath("//span[.=' 30% off on making charge ']"));
