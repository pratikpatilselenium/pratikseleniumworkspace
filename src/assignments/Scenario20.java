...
public class Scenario20 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//span[@data-p='l-gold-coins-weight-20gms,m']")).click();
		WebElement lakshmiCoin = driver.findElement(By.xpath("//h1[.='20 gram 24 KT Lakshmi Gold Coin']"));
