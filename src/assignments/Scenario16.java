...
public class Scenario16 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//span[.='20 gram' and @data-p='gold-coins-weight-20gms,m' ]")).click();
		WebElement coin = driver.findElement(By.xpath("//h1[.='20 gram 24 KT Gold Coin']"));
