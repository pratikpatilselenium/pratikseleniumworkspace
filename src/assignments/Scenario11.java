...
public class Scenario11 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//span[@class='prcs-dlh' and @data-displayname='10% Making Charge Off' ]")).click();
		List<WebElement> discount = driver.findElements(By.xpath("//span[.=' 10% off on making charge ']"));
